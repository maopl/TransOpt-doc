...
.. admonition:: Overview
   ...
   - :ref:`Register a New Results Analysis Method <registering-new-analysis>`: How to add a new results analysis method to :ref:`PrismBO <home>`.
   ...
   - :ref:`Performance Evaluation Metrics <performance-evaluation-metrics>`: The list of the performance evaluation metrics available in :ref:`PrismBO <home>`
   - :ref:`Statistical Measures <statistical-measures>`: The list of the statistical measures supportede in :ref:`PrismBO <home>`
